...
def solve_brain_tissue_module_figure7(t_dur, alpha, I_stim, stim_start, stim_dur, module_version):
    """
    ...
    Arguments:
        ...
        stim_start (array): times of stimulus onset [s]
    ...
    def dkdt(t,k):
        ...
        if module_version == 'no glia':
            my_cell.g_Na_leak_g = 0
            my_cell.g_Cl_leak_g = 0
            my_cell.g_K_IR = 0
            my_cell.rho_g = 0
            my_cell.G_g = 0
        if module_version == 'with glia no swelling':
            my_cell.G_g = 0
            my_cell.G_n = 0
        if module_version == 'no glia no swelling':
            my_cell.g_Na_leak_g = 0
            my_cell.g_Cl_leak_g = 0
            my_cell.g_K_IR = 0
            my_cell.rho_g = 0
    ...
    my_cell = BrainTissueModule(T, Na_sn, Na_se, Na_sg, Na_dn, Na_de, Na_dg, K_sn, K_se, K_sg, K_dn, K_de, K_dg, Cl_sn, Cl_se, Cl_sg, Cl_dn, Cl_de, Cl_dg, \
