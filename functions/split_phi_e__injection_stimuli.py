...
def split_phi_e(my_cell, t, I_stim, stim_start, stim_end, dendritic_stimuli=False):
    """
    ...
    Arguments: 
        ...
        t (array): time
        I_stim (float): stimulus current
        stim_start (float): time of stimulus onset
        stim_end (float): time of stimulus offset
